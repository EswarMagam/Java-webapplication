...
<body>
	...
	<div>
		<h2 align="center" style="font-weight: bolder;">ADD NEW TEST</h2>
	</div>
	<div class="form">
		<div>
			<form:form action="${contextPath}/addNewTest" modelAttribute="tests"
				method="post">
				<div>
				...
				<div>
					<div>
						<input type="submit" value="Add Test" class="button gradient-bg">
					</div>
				</div>
			</form:form>
		</div>
